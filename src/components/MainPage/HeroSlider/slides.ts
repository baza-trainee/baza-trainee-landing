...
export const slides = [
  {
    ...
    title: {
      en: 'Baza Trainee Ukraine',
      ua: 'Baza Trainee Ukraine',
      pl: 'Baza Trainee Ukraine',
    },
    subtitle: {
      en: 'A public organization that provides initial work experience to those who are just starting their journey in IT.',
  ...
  {
    imageUrl: '/img/carousel-slide-2.webp',
    title: {
      en: 'About',
      ua: 'Про нас',
      pl: 'O nas',
  ...
  {
    imageUrl: '/img/carousel-slide-5.webp',
    title: {
    ...
    subtitle: {
      en: 'Ukrainians who are acquiring skills in the IT field, regardless of their age and experience level, form one side of our target audience. This includes trainees, juniors, career switchers, and mentors. On the other side, our audience consists of charitable organizations, volunteering communities, and civic initiatives in Ukraine. ',
      ua: 'Українці, які опановують спеціальності в сфері ІТ незалежно від віку і досвіду- трейні, джуніори, світчери, ментори з однієї сторони, і громади та спільноти України  в сфері благодійності, волонтерства, громадських ініціатив з іншої.',
      pl: 'Ukraińcy, którzy opanowują specjalizacje IT bez względu na wiek i doświadczenie - stażyści, juniorzy, pocieszyciele, mentorzy z jednej strony, a ukraińskie społeczności i organizacje w dziedzinie działalności charytatywnej, wolontariatu i inicjatyw publicznych z drugiej strony.',
    },
  },
  {
    imageUrl: '/img/carousel-slide-3.webp',
    title: {
      en: 'Our Goal',
      ua: 'Наша ціль',
      pl: 'Nasz cel',
  ...
  {
    imageUrl: '/img/carousel-slide-4.webp',
    title: {
      en: 'Principle of Action',
      ua: 'Принцип дії',
      pl: 'Zasady działania',
    },
    subtitle: {
