export const slides = [
  ...
  },
  {
    ...
    title: 'Принцип дії',
    text: 'Тренувати учасника на основі технологій, якими він володіє на даний момент, і сприяти його працевлаштуванню. Застосовувати при створенні проекту технології, які хоче розвивати учасник, перенавчання не відбувається. Забезпечити замовника якісним цифровим продуктом.',
  },
];
