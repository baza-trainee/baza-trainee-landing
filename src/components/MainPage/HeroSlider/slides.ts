export const slides = [
  {
    ...
    text: 'Громадська організація, яка має на меті допомогти отримати перший досвід роботи тим, хто починає свій шлях в IT',
  },
  {
  ...
  },
  {
    ...
    title: 'Наша місія',
    text: 'Поєднати в спільній діяльності ці категорії таким чином, щоб користь отримали обидві сторони. Для першої групи – це реальний практичний досвід створення справжнього продукту, для другої – цифровий продукт, що працює і сприяє розвитку соціального проекту.',
  },
  {
    image: '/img/carousel-slide-4.png',
    title: 'Принцип дії',
    text: 'Тренувати учасника на основі технологій, якими він володіє на даний момент, і сприяти його працевлаштуванню. Застосовувати при створенні проекту технології, які хоче розвивати учасник, перенавчання не відбувається.',
  },
  {
